...
Both means and standard deviation were given by the professor and the goal is to create 400 samples, equally divided among 4 classes, using Gaussian distribution to generate the points for each class.
...
### Figure 1 - 2D scatter plot with all the points, one color per class, with the **center** of each cloud (mean) marked on the plot

![Scatter plot of four Gaussian classes and their means](images/synthetic_gaussian_data.png)